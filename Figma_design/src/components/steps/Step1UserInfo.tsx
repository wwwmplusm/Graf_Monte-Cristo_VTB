...
export function Step1UserInfo({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (userId.trim() && agreedToTerms) {
      onNext(userId.trim(), userId.trim()); // Pass userId as both parameters
    }
  };
  ...
  return (
    <div className="w-full max-w-md mx-auto">
      <div className="text-center mb-8 md:mb-10">
        <h1 className="mb-3 md:mb-4">Добро пожаловать в ФинПульс</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
        ...
        <div className="flex flex-col gap-3">
          <Button
            ...
            disabled={!userId.trim() || !agreedToTerms}
          >
            Продолжить
          </Button>
          <Button
